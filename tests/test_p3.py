...
class TestXrayConfigP3:
    ...
    def test_version_is_a_release_number(self):
        # VERSION is the single source for the Debian package version, so what
        # matters is that it stays parseable -- pinning the literal here only
        # meant editing this test on every release.
        import main as m2
