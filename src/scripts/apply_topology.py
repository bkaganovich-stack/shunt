...
Usage: apply_topology.py            # reads /opt/xray-proxy/config/topology-target.json
...
DNSMASQ_CONF = Path("/etc/dnsmasq.d/gateway.conf")
...
def netplan_inline(t: dict) -> str:
    ...
    return ("# Generated by xray-gateway apply_topology.py (INLINE) — do not edit.\n"
            "network:\n  version: 2\n  ethernets:\n" + wan_block + "\n" + lan_block + "\n")

def netplan_loop(t: dict) -> str:
    ns = ", ".join(t.get("nameservers", ["9.9.9.9"]))
    lan = t["lan_if"]
    return (f"""# Generated by xray-gateway apply_topology.py (LOOP) — do not edit.
network:
  version: 2
  ethernets:
    {lan}:
...
def write_dnsmasq(t: dict) -> None:
    ...
    if t["topology"] == "inline":
        conf = (f"# Generated by xray-gateway (INLINE) — do not edit manually\n"
        ...
        conf = (f"# Generated by xray-gateway (LOOP) — do not edit manually\n"
...
def safe_harbor_loop() -> tuple[bool, str]:
    ...
    run("systemctl", "restart", "sing-box", timeout=30)
    run("systemctl", "restart", "xray-proxy", check=False, timeout=30)
    return True, lan
